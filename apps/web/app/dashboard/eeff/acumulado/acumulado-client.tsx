            ...
            <table className="w-full text-xs">
              <thead className="bg-[#0f1e3a] border-b-2 border-brand-400">
                <tr>
                  ...
                  <th className="text-right px-3 py-2 text-xs font-semibold uppercase tracking-wider text-slate-300 w-24">{data.periodoPrev.label}</th>
                  <th className="text-right px-3 py-2 text-xs font-semibold uppercase tracking-wider text-slate-300 w-24">{data.periodoActual.label}</th>
                  <th className="text-right px-3 py-2 text-xs font-semibold uppercase tracking-wider text-slate-300 w-24">Var. S/.</th>
                  <th className="text-right px-3 py-2 text-xs font-semibold uppercase tracking-wider text-slate-300 w-20">Var. %</th>
                  <th className="text-right px-3 py-2 text-[10px] font-semibold uppercase tracking-wider text-slate-300 w-20">

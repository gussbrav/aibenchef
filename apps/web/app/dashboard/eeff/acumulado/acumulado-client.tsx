          ...
          <div className="bg-white border border-slate-200 rounded-lg overflow-hidden">
            <table className="w-full text-xs">
              <thead className="bg-white border-b-2 border-slate-300">
                <tr>
                  <th className="text-left px-3 py-2 text-xs font-semibold uppercase tracking-wider text-slate-600">
                    Estado de Resultados
                  </th>
                  <th className="text-right px-3 py-2 text-xs font-semibold uppercase tracking-wider text-slate-600 w-24">{data.periodoPrev.label}</th>
                  <th className="text-right px-3 py-2 text-xs font-semibold uppercase tracking-wider text-slate-600 w-24">{data.periodoActual.label}</th>
                  <th className="text-right px-3 py-2 text-xs font-semibold uppercase tracking-wider text-slate-600 w-24">Var. S/.</th>
                  <th className="text-right px-3 py-2 text-xs font-semibold uppercase tracking-wider text-slate-600 w-20">Var. %</th>
                  <th className="text-right px-3 py-2 text-[10px] font-semibold uppercase tracking-wider text-slate-600 w-20">
